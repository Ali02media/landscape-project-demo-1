	...
	return (
		<header
			className={cn('sticky top-0 z-50 w-full border-b border-transparent transition-all duration-300', {
				'bg-background/95 supports-[backdrop-filter]:bg-background/50 border-border backdrop-blur-lg py-2':
					scrolled,
		...
		>
			<nav className="mx-auto flex w-full max-w-5xl items-center justify-between px-4">
				<div className="flex items-center gap-4">
					<a href="tel:07495308444" className={buttonVariants({ variant: 'default' })}>
						Call 07495 308444
					</a>
					<Button
						size="icon"
			...
			<MobileMenu open={open} className="flex flex-col justify-between gap-2">
				...
				<div className="flex flex-col gap-2">
					<a href="tel:07495308444" className={buttonVariants({ variant: 'default', className: 'w-full' })}>
						Call 07495 308444
					</a>
				</div>
			</MobileMenu>
